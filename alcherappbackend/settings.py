"""
Django settings for alcherappbackend project.
...
SECRET_KEY = 'd7(-j)ip*2xfy&2h78%ibapv965vbyzc)l$y2w9mc0)evaoai8'
...
ROOT_URLCONF = 'alcherappbackend.urls'
...
WSGI_APPLICATION = 'alcherappbackend.wsgi.application'
